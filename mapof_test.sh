...
build_target() {
    ...
    if ! go test mapof_test.go mapof.go mapof_deprecated.go mapof_experimental.go mapof_opt_cachelinesize.go mapof_opt_atomiclevel.go mapof_opt_*_off.go atomic_utils.go -c -o pb.test; then
